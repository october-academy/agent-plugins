...
1. What is this interface for? Who is the audience?
2. What aesthetic direction fits best? (minimalist, maximalist, retro-futuristic, organic, brutalist, etc.)
3. What technical constraints exist? (framework, existing design system, accessibility requirements)
4. What will make this design memorable and distinctive?
